function KonsultasiHead() {
    return (
        <>
            ...
            <div className=" w-full  h-80 px-20 py-12 flex-col justify-start items-center gap-6 inline-flex">
                <div className="max-w-2xl w-full h-44 flex-col justify-start items-center gap-3 flex ">
                    <div className="self-stretch h-28 flex-col justify-start items-center gap-1 flex">
