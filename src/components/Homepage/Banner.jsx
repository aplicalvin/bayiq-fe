                    ...
                    <div className="mx-auto flex items-center pl-6">
                        <p className="flex items-center text-sm font-normal text-gray-500 ">
                            <span className="flex gap-3 text-xs md:text-base text-stone-100 place-items-center">
                                ...
                                <Link
                                    to="/roadmap"
                                    className="text-center ml-0 flex items-center text-xs md:text-base font-medium bg-primary-700 text-stone-100 hover:bg-primary-800 md:ml-1 md:inline-flex py-1 px-3 rounded-md"
                                >
                                    Mulai dari sini
                                </Link>
                            </span>
