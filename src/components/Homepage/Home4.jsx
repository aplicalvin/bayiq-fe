import ImgHome4 from "../../assets/assets/image/Home4.png";
...
function Home4() {
    return (
        <>
            <div className="">
                <div className="grid md:flex gap-12 items-center max-w-screen-xl w-fit mx-12 md:mx-auto  mt-12">
                    {/* text */}
                    <div className="max-w-2xl w-full grid gap-3 h-fit order-1 ">
